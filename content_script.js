...
class SyncUpSidebar {
  ...
  renderAllItems(items, listContainer) {
    ...
    // Add click event listeners to Read More/Less buttons for cards
    ...
    // Add click event listeners to Read More/Less buttons for chat
    const chatReadMoreBtns = listContainer.querySelectorAll('.chat-read-more-btn');
    chatReadMoreBtns.forEach(btn => {
      btn.addEventListener('click', (e) => {
        e.stopPropagation();
    ...
    const chatReadLessBtns = listContainer.querySelectorAll('.chat-read-less-btn');
    chatReadLessBtns.forEach(btn => {
      btn.addEventListener('click', (e) => {
        e.stopPropagation();
        const index = parseInt(btn.getAttribute('data-chat-index'));
        this.toggleCard(index);
